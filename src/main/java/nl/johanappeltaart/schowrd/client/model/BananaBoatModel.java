//package com.johanappeltaart.schowrd.client.model;
//
...
//
////public class BananaBoatModel<T extends BananaBoatEntity> extends EntityModel<T> {
//    public class BananaBoatModel extends SegmentedModel<BananaBoatEntity> {
//
...
//         */
//        @Override
//        public void setRotationAngles(BananaBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
//            this.func_228244_a_(entityIn, 0, limbSwing);
//            this.func_228244_a_(entityIn, 1, limbSwing);
//        }
//
...
//        }
//
//        protected void func_228244_a_(BananaBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
