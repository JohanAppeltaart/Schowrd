...
//import com.johanappeltaart.schowrd.tileentity.ChestTileEntity;
import nl.johanappeltaart.schowrd.tileentity.BananaChestTileEntity;
...
public class SecretBananaChestBlock extends SecretAbstractChestBlock<BananaChestTileEntity> implements IWaterLoggable{
	public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
	public static final EnumProperty<ChestType> TYPE = BlockStateProperties.CHEST_TYPE;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	protected static final VoxelShape SHAPE_NORTH = makeCuboidShape(1.0D, 0.0D, 0.0D, 15.0D, 14.0D, 15.0D);
	protected static final VoxelShape SHAPE_SOUTH = makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 14.0D, 16.0D);
	protected static final VoxelShape SHAPE_WEST = makeCuboidShape(0.0D, 0.0D, 1.0D, 15.0D, 14.0D, 15.0D);
	protected static final VoxelShape SHAPE_EAST = makeCuboidShape(1.0D, 0.0D, 1.0D, 16.0D, 14.0D, 15.0D);
	protected static final VoxelShape SHAPE_SINGLE = makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 14.0D, 15.0D);
	...
	public SecretBananaChestBlock(SecretAbstractChestBlock.Properties builder, Supplier<TileEntityType<? extends BananaChestTileEntity>> tileEntityTypeIn) {
	...
	@Nullable
	public static IInventory getChestInventory(SecretBananaChestBlock chest, BlockState state, World world, BlockPos pos, boolean override) {
	...
	public TileEntityMerger.ICallbackWrapper<? extends ChestTileEntity> combine(BlockState state, World world, BlockPos pos, boolean override) {
		...
		if (override) {
			...
			bipredicate = SecretBananaChestBlock::isBlocked;
		}
		return null;
//		return TileEntityMerger.func_226924_a_(this.tileEntityType.get(), SecretBananaChestBlock::getChestMergerType, SecretBananaChestBlock::getDirectionToAttached, FACING, state, world, pos, bipredicate);
	}
