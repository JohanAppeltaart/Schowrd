...
////import com.telepathicgrunt.schowrd.capabilities.IPlayerPosAndDim;
////import com.telepathicgrunt.schowrd.capabilities.PlayerPositionAndDimension;
////import com.telepathicgrunt.schowrd.utils.BzPlacingUtils;
//import com.johanappeltaart.schowrd.util.BBPlacingUtils;
...
//
//public class BoundlessBananasPlayerPlacement {
//
...
//            ServerWorld bumblezoneWorld = minecraftServer.getWorld(BoundlessBananasDimension.BOUNDLESSBANANAS_WORLD_KEY);
//
...
//                LogManager.getLogger().log(Level.INFO, "Schowrd: Please restart the server. The Bumblezone dimension hasn't been made yet due to this bug: https://bugs.mojang.com/browse/MC-195468. A restart will fix this.");
...
//
//        PlayerPositionAndDimension cap = (PlayerPositionAndDimension) playerEntity.getCapability(PAST_POS_AND_DIM).orElseThrow(RuntimeException::new);
//        if (Schowrd.BoundlessBananasDimensionConfig.teleportationMode.get() != 2 || cap.getNonBZPos() == null) {
...
//
//
//        if (Schowrd.BoundlessBananasDimensionConfig.teleportationMode.get() == 2 ||
//                (Schowrd.BoundlessBananasDimensionConfig.teleportationMode.get() == 3 && validBlockPos == null)) {
...
//                    blockpos.getX(),
//                    BBPlacingUtils.topOfSurfaceBelowHeightThroughWater(bumblezoneWorld, blockpos.getY(), 0, blockpos) + 1,
//                    blockpos.getZ());
//
...
//            if (!Schowrd.BoundlessBananasDimensionConfig.seaLevelOrHigherExitTeleporting.get() ||
...
//        if(Schowrd.BoundlessBananasDimensionConfig.teleportationMode.get() == 3) return null;
//
...
//                position.getX(),
//                BBPlacingUtils.topOfSurfaceBelowHeight(world, maxHeight, 0, position),
//                position.getZ());
//
...
//        if(Schowrd.BoundlessBananasDimensionConfig.generateBeenest.get())
