...
//
//
//public class BoundlessBananasChunkGenerator extends ChunkGenerator {
//    public static void registerChunkgenerator() {
//        Registry.register(Registry.CHUNK_GENERATOR, new ResourceLocation(Schowrd.MOD_ID, "chunk_generator"), BoundlessBananasChunkGenerator.CODEC);
//    }
//
//    public static final Codec<BoundlessBananasChunkGenerator> CODEC = RecordCodecBuilder.create(
...
//            ).apply(instance, instance.stable(BoundlessBananasChunkGenerator::new)));
//
...
//
//    public BoundlessBananasChunkGenerator(BiomeProvider biomeSource, DimensionStructuresSettings dimensionStructuresSettings) {
//        this(biomeSource, biomeSource, dimensionStructuresSettings);
//    }
//
//    private BoundlessBananasChunkGenerator(BiomeProvider biomeSource, BiomeProvider biomeSource2, DimensionStructuresSettings dimensionStructuresSettings) {
...
//        return new BoundlessBananasChunkGenerator(this.biomeProvider.withSeed(seed), dimensionStructuresSettings);
//    }
//
...
////                        }
////
////                        //Schowrd.LOGGER.log(Level.INFO, " outside beeproductive check");
//////						if(FabricLoader.getInstance().isModLoaded("beeproductive")) {
//////							//Schowrd.LOGGER.log(Level.INFO, " inside beeproductive check. passed with flying colors");
//////							entity = BeeProductiveIntegration.spawnBeeProductiveBee(region.getRandom(), entity);
//////						}
////                    }
////                } catch (Exception exception) {
////                    Schowrd.LOGGER.warn("Failed to create mob", exception);
////                    continue;
////                }
////
...
//            {
//                chunk.setBlockState(blockpos$Mutable.setPos(blockpos.getX(), ceilingY, blockpos.getZ()), ModBlocks.BANANA_PLANKS.get().getDefaultState(), false);
//            }
//
//            //single layer of solid blocks
//            for (int floorY = 0; floorY <= floorHeight + random.nextInt(2); ++floorY)
//            {
//                chunk.setBlockState(blockpos$Mutable.setPos(blockpos.getX(), floorY, blockpos.getZ()), ModBlocks.BANANA_PLANKS.get().getDefaultState(), false);
//            }
//        }
//    }
//
