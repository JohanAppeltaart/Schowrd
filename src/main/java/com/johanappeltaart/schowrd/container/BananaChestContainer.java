...
//        return new BananaChestContainer(ModContainerTypes.BANANA_CHEST, id, player, 6);
//    }

    public BananaChestContainer(ContainerType type, int id, PlayerInventory playerInventoryIn, IInventory p_i50092_4_, int rows) {
        super(type, id);
