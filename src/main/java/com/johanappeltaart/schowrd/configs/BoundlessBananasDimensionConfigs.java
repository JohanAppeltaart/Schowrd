package com.johanappeltaart.schowrd.configs;
...
public class BoundlessBananasDimensionConfigs {

    public static class BoundlessBananasDimensionConfigValues {
        ...
        public BoundlessBananasDimensionConfigValues(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber) {
            ...
            builder.push("The Bumblezone Dimension Options");
                ...
                fogBrightnessPercentage = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.fogbrightnesspercentage")
            ...
            builder.push("The Bumblezone Teleportation Options");
                ...
                teleportationMode = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.teleportationmode")
                ...
                generateBeenest = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.generatebeenest")
                ...
                forceExitToOverworld = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.forceexittooverworld")
                ...
                seaLevelOrHigherExitTeleporting = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.sealevelorhigherexitteleporting")
                ...
                requiredBlockUnderHive = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.requiredblockunderhive")
                ...
                warnPlayersOfWrongBlockUnderHive = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.warnplayersofwrongblockunderhive")
                ...
                allowTeleportationWithModdedBeehives = subscriber.subscribe(builder
                    ...
                    .translation("schowrd.config.dimension.allowteleportationwithmoddedbeehives")
