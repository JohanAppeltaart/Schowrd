...
@OnlyIn(
    ...
    public class BananaChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
        ...
        protected BananaChestTileEntity(TileEntityType<?> typeIn) {
            super(typeIn);
        }
        ...
        public static void swapContents(BananaChestTileEntity chest, BananaChestTileEntity otherChest) {
