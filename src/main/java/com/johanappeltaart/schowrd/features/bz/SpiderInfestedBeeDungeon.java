...
//        //affect rarity
//        if (Schowrd.BzDungeonsConfig.spiderInfestedBeeDungeonRarity.get() >= 1000 ||
//            random.nextInt(Schowrd.BzDungeonsConfig.spiderInfestedBeeDungeonRarity.get()) != 0) return false;
//
...
//                random.nextFloat() < Schowrd.BzModCompatibilityConfig.PBOreHoneycombSpawnRateSpiderBeeDungeon.get())
//            {
//                return new Pair<>(ProductiveBeesRedirection.PBGetRandomHoneycomb(random,
//                        Schowrd.BzModCompatibilityConfig.PBGreatHoneycombRaritySpiderBeeDungeon.get()), false);
//            }
//            else if(ModChecker.productiveBeesPresent &&
//                    Schowrd.BzModCompatibilityConfig.spawnProductiveBeesHoneycombVariants.get() &&
...
//                        false);
//            } else if (random.nextDouble() < Schowrd.BzDungeonsConfig.spawnerRateSpiderBeeDungeon.get()) {
...
//            {
//                return new Pair<>(ProductiveBeesRedirection.PBGetRandomHoneycomb(random,
//                        Schowrd.BzModCompatibilityConfig.PBGreatHoneycombRaritySpiderBeeDungeon.get()), replaceAir);
//            }
//
//            if (random.nextFloat() < 0.15f) {
