...
//import com.johanappeltaart.schowrd.mixin.TemplateInvoker;
...
////import com.telepathicgrunt.the_Schowrd.blocks.HoneyCrystal;
////import com.telepathicgrunt.the_Schowrd.blocks.HoneycombBrood;
////import com.telepathicgrunt.the_Schowrd.mixin.TemplateInvoker;
////import com.telepathicgrunt.the_Schowrd.modCompat.ModChecker;
////import com.telepathicgrunt.the_Schowrd.modCompat.ProductiveBeesRedirection;
...
//
//    private static final BlockState HONEY_CRYSTAL = Blocks.EMERALD_BLOCK.getDefaultState();
//
...
//        //affect rarity
//        if (Schowrd.BoundlessBananasDungeonsConfig.beeDungeonRarity.get() >= 1000 ||
//            random.nextInt(Schowrd.BoundlessBananasDungeonsConfig.beeDungeonRarity.get()) != 0) return false;
//
//        BlockPos.Mutable blockpos$Mutable = new BlockPos.Mutable().setPos(position).move(-3, -2, -3);
//        //Schowrd.LOGGER.log(Level.INFO, "Bee Dungeon at X: "+position.getX() +", "+position.getY()+", "+position.getZ());
//
...
//        Template structure = structureManager.getTemplateDefaulted(new ResourceLocation(Schowrd.MOD_ID + ":bee_dungeon/shell"));
...
//
//
//        structure = structureManager.getTemplateDefaulted(new ResourceLocation(Schowrd.MOD_ID + ":bee_dungeon/altar"));
...
////                random.nextFloat() < Schowrd.BoundlessBananasModCompatibilityConfig.PBOreHoneycombSpawnRateBeeDungeon.get())
////            {
////
////                return new Pair<>(ProductiveBeesRedirection.PBGetRandomHoneycomb(random,
////                        Schowrd.BoundlessBananasModCompatibilityConfig.PBGreatHoneycombRarityBeeDungeon.get()), false);
////            }
////
////            if (random.nextFloat() < 0.4f) {
////                return new Pair<>(new Pair<>(Blocks.HONEYCOMB_BLOCK.getDefaultState(), null), false);
////            } else {
////                return new Pair<>(new Pair<>(BoundlessBananasBlocks.FILLED_POROUS_HONEYCOMB.getDefaultState(), null), false);
////            }
//        }
//
//        //south wall
...
////                return new Pair<>(new Pair<>(BoundlessBananasBlocks.HONEYCOMB_BROOD.getDefaultState()
...
////            } else {
////                return new Pair<>(new Pair<>(ModBlocks.FILLED_POROUS_HONEYCOMB.getDefaultState(), null), false);
////            }
////        }
//
//        //west wall
...
////                return new Pair(new Pair<>(HONEY_CRYSTAL, true), null);//, false);.with(HoneyCrystal.WATERLOGGED
////            } else {
...
////            {
//////                return new Pair<>(ProductiveBeesRedirection.PBGetRandomHoneycomb(random,
//////                        Schowrd.BoundlessBananasModCompatibilityConfig.PBGreatHoneycombRarityBeeDungeon.get()), replaceAir);
////            }
////
////            if (random.nextFloat() < 0.4f) {
////                return new Pair<>(new Pair<>(Blocks.HONEYCOMB_BLOCK.getDefaultState(), null), replaceAir);
////            } else {
//////                return new Pair<>(new Pair<>(BoundlessBananasBlocks.FILLED_POROUS_HONEYCOMB.getDefaultState(), null), replaceAir);
////            }
////        }
////
////        //outer ring
