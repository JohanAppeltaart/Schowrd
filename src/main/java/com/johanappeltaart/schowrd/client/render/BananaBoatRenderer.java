package com.johanappeltaart.schowrd.client.render;

import com.johanappeltaart.schowrd.client.model.BananaBoatModel;
...
public class BananaBoatRenderer extends EntityRenderer<BananaBoatEntity> {
    ...
    public void render(BananaBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(BananaBoatEntity entity) {
//        return BOAT_TEXTURES[entity.getBoatType().ordinal()];
        return new ResourceLocation("textures/entity/boat/banana.png");
    }
}
