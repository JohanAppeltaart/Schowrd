...
//        this.func_238474_b_(p_230450_1_,i,j,0,0,this.xSize,this.ySize);
        this.drawTexture(p_230450_1_, i, j, 0, 0, this.xSize, this.inventoryRows * 18 + 17);//17
        this.drawTexture(p_230450_1_, i, j + this.inventoryRows * 18 + 17, 0, 126, this.xSize, 96);
    }
