...
public class ForgeMod implements WorldPersistenceHooks.WorldPersistenceHook
{
    ...
    public static final RegistryObject<Attribute> NAMETAG_DISTANCE = ATTRIBUTES.register("nametag_distance", () -> new RangedAttribute("forge.nameTagDistance", 64.0D, 0.0D, Float.MAX_VALUE).setShouldWatch(true));
