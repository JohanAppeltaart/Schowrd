...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (maxPages != 0) {
          ...
          font.func_238407_a_(matrixStack, page.func_241878_f(), guiLeft + (xSize / 2) - (font.getStringPropertyWidth(page) / 2), guiTop - 44, -1);
   ...
   protected void renderTooltip(MatrixStack matrixStack, ItemStack itemStack, int mouseX, int mouseY) {
      if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
         ...
         this.renderToolTip(matrixStack, Lists.transform(list1, ITextComponent::func_241878_f), mouseX, mouseY, (font == null ? this.font : font));
